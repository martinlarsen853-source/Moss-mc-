      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-4">
        ...
        <div className="space-y-2">
          <div className="flex gap-2">
            <input value={presetEmoji} onChange={(e) => setPresetEmoji(e.target.value)} className="w-14 bg-zinc-800 rounded-lg px-2 py-2.5 text-center text-xl border border-zinc-700" placeholder="🍽️" />
            <input value={presetName} onChange={(e) => setPresetName(e.target.value)} className="flex-1 bg-zinc-800 rounded-lg px-3 py-2.5 text-sm border border-zinc-700 placeholder-zinc-600" placeholder="Navn (f.eks. Sardinlunsj)" />
          </div>
          <div className="flex gap-2">
            <input value={presetKcal} onChange={(e) => setPresetKcal(e.target.value)} className="flex-1 bg-zinc-800 rounded-lg px-3 py-2.5 text-sm border border-zinc-700 placeholder-zinc-600" placeholder="Kalorier (kcal)" type="number" inputMode="numeric" />
            <input value={presetProtein} onChange={(e) => setPresetProtein(e.target.value)} className="flex-1 bg-zinc-800 rounded-lg px-3 py-2.5 text-sm border border-zinc-700 placeholder-zinc-600" placeholder="Protein (g)" type="number" inputMode="numeric" />
          </div>
          <button onClick={savePreset} className="w-full bg-white text-black rounded-lg py-2.5 font-medium text-sm active:bg-zinc-200">
